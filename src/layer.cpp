...
// Setters
void Layer::setType(const int &type) { this->type = type; }

void Layer::setResType(const QString &resType) { this->resType = resType; }
...
void Layer::setCanvas(const QImage &canvas) { this->canvas = canvas; }

void Layer::setResource(const QString &resource) { this->resource = resource; }

void Layer::setAlign(const QString &align) { this->align = align; }

void Layer::setVAlign(const QString &valign) { this->valign = valign; }

void Layer::setScaling(const QString &scaling) { this->scaling = scaling; }

void Layer::setX(const int &x) { this->x = x; }

void Layer::setY(const int &y) { this->y = y; }

void Layer::setWidth(const int &width) { this->width = width; }

void Layer::setHeight(const int &height) { this->height = height; }
...
void Layer::setRed(const int &red) { this->red = red; }

void Layer::setGreen(const int &green) { this->green = green; }

void Layer::setBlue(const int &blue) { this->blue = blue; }

void Layer::setDistance(const int &distance) { this->distance = distance; }

void Layer::setSoftness(const int &softness) { this->softness = softness; }
...
// Add new layer
void Layer::addLayer(const Layer &layer) { this->layers.append(layer); }

QList<Layer> Layer::getLayers() { return layers; }
