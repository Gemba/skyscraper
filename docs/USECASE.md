...
The important thing to note is that the defaults for Skyscraper is set to work well for most users. So unless you see something you want to change, you do not have to. But it's equally important to know that you _can_.
